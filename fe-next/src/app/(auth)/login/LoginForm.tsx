  ...
  return (
    <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4" suppressHydrationWarning>
        ...
        <button
          type="submit"
          className="w-full py-2 px-4 bg-primary text-blue-500 font-medium rounded-md hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
          suppressHydrationWarning
        >
          Login
        </button>
      ...
      <p className="mt-4 text-center text-sm text-gray-600">
        Don't have an account? <Link href="/signup" className="font-medium text-primary hover:text-primary-dark">Sign Up</Link>
      </p>
    </div>
  );
} 